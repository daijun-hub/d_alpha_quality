...
class DetectType(Enum):
    ...
    ELEVATION_KITCHEN = "decor_arch_elevation_entity_det_kitc"
    ELEVATION_WASHROOM = "decor_arch_elevation_entity_det_wash"
...
class DetectConfig:
    ...
    SCORE_THRESHOLD = {  # NMS置信度阈值
        ...
        DetectType.ELEVATION_KITCHEN: 0.4,
        DetectType.ELEVATION_WASHROOM:0.4,
    }
    ...
    MODEL_URL_SUFFIX = {  # 模型url后缀
        ...
        DetectType.ELEVATION_WASHROOM: "/api/v1/pinshi/detection",
        DetectType.ELEVATION_KITCHEN: "/api/v1/pinshi/detection",
    }
    ...
    MODEL_URL = {
        ...
        "bgy_dev": {
            DetectType.INDOOR_KITCHEN: getenv("decor_detection_indoor_kitchen", "http://124.70.184.163:9110"),
            DetectType.INDOOR_WASHROOM: getenv("detection_indoor_washroom", "http://123.60.40.81:9007"),
            DetectType.INDOOR_BALCONY: getenv("decor_detection_indoor_balcony", "http://124.71.158.131:32040"),
            DetectType.INDOOR_LIVINGROOM: getenv("detection_indoor_livingroom", "http://123.60.40.81:9004"),
            DetectType.INDOOR_BEDROOM: getenv("detection_indoor_bedroom", "http://121.36.197.103:9008"),
            DetectType.ELEVATION_KITCHEN: getenv("detection_elevation_kitchen", ''),
            DetectType.ELEVATION_WASHROOM: getenv("detection_elevation_washroom", ''),
        }
    }
