...
class LayerConfig(Enum):
    ...
    ENTITY_LAYER_DICT = {
        ...
        # "立管" 类 - 之前的 "立管" 图层改为 "其他立管" 图层
        # "vpipe": {  # 立管
        #     "layer_sub": ["VPIPE", "立管", "S[-_]EQUIPMENT", "雨水", "冷凝管", "给水", "污水管", "消防管", "废水管",
        #                   "EQPM[-_]PLUM", "EQUIP[-_]水", "DRAI[-_]EQPM", "EQPM[-_]DRAI", "VERT[-_]PIPE",
        #                   "P[-_].{13}[-_]L", "WATER", "排水", "^水$", "水管", "LG", "lg", "PUB[-_]STRM",
        #                   "0P[-_]ACC[-_]FD", "^A[-_]SAN$", "EQPM[-_]PUMB", "P[-_]SEWR", "F[-_]废水[-_]SILO",
        #                   "RAIN[-_]EQPM", "P[-_]ZP[-_]VPIP[-_]IDEN", "P-XH-VPIP-IDEN", "P-YS-VPIP-IDEN",
        #                   "P-YS-VPIP+IDEN", "P-FS-VPIP-IDEN", "P-TQ-VPIP-IDEN", "P-WS-VPIP-IDEN", "P-NS-VPIP-IDEN"],
        ...
        "ventilate_vpipe": {  # 通气立管
            "layer_sub": ["P[-_]VPIPE[-_]其他", "VPIPE[-_]其他", "VPIPE[-_]通气", "S[-_]VPIPE[-_]TQ", "WP[-_]T[-_]LG",
                          "P[-_]通气管立管", "P[-_]VENT[-_]VPIP", "S[-_]通气管", "AERATE[-_]VERT", "P-TQ-VPIP-IDEN", "通气管", "通气[-_]VPIPE"],
            "ignore_word": list(set(BASIC_IGNORE_WORDS["basic"]) - {"IDEN"}) +
                           ["雨水斗", "编号", "NO\.", "^[^Vv]*PIPE", "^S-给水$", "P-雨水-EQPM", "S[-_]排水", "-P-废水管",
                            "P[-_]消防管[-_]PJ", "立管定位", "辅助"],
        },
        ...
        # "sewage_hpipe_vpipe_annotation": {  # 污水横管、立管、引注混合图层
        #     "layer_sub": ["排污[-_]立管编号", "P[-_]WS"],
        #     "ignore_word": []
        # },
        # "condensate_hpipe_vpipe_annotation": {  # 冷凝横管、立管、引注混合图层
        #     "layer_sub": ["DIM[-_]凝结"],
        #     "ignore_word": []
        # },
        # "rain_hpipe_vpipe_annotation": {  # 雨水横管、立管、引注混合图层
        #     "layer_sub": ["P[-_]YS"],
        #     "ignore_word": []
        # },
        # "waste_hpipe_vpipe_annotation": {  # 废水横管、立管、引注混合图层
        #     "layer_sub": ["P[-_]FS"],
        #     "ignore_word": []
        # },
        # "life_supply_hpipe_vpipe_annotation": {  # 给水横管、立管、引注混合图层
        #     "layer_sub": ["P[-_]J", "P[-_]JS"],
        #     "ignore_word": []
        # },
