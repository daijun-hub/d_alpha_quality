...
# 合并且分类构件
class DianTiJiaoXiang(ClassifiedEntity):
    ...
    def __init__(self, entity_object: Entity, border_entity: BorderEntity) -> None:
        ...
        self.chinese_name = "电梯轿厢"
        self.entity_base_type = EntityBaseType.MECHANICAL_DEVICE
        # 电梯编号
        self.elevator_number = get_entity_label_number(self.bounding_rectangle.list, border_entity, extend_margin=1200, map_label="DT")
        # 停靠楼层
        ...
        # 是否为贯通梯(前后开门)
        self.is_through = len(get_entity_nearby_entity(self.bounding_rectangle.list, border_entity, extend_margin=1800, map_label="elevator_door")) > 1
        # 底坑深度， 利用标高相减
